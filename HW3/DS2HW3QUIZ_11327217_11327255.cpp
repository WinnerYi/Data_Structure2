...
public:
    ...
    void buildDoubleHashTable() {
        ...
        calculateDoubleSearchStatistics(maxStep, dataInserted, successfulTotal);
    ...
    void calculateDoubleSearchStatistics(int maxStep, int validRecords, double successfulTotal) {
        double successfulAvg = (validRecords > 0) ? successfulTotal / validRecords : 0;
        cout << fixed << setprecision(4);
        cout << "successful search: " << successfulAvg << " comparisons on average\n";
    }
